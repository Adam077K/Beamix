# DECISIONS_ARCHIVE.md — Pre-rethink era (before 2026-04-15)

*Archived from `.claude/memory/DECISIONS.md` on 2026-05-08 as part of WS3 lock to keep the active log under 50 entries (per Adam's hard rule). Entries pre-dating the 2026-04-15 product rethink are preserved here for historical context.*

*Active log starts from `[2026-04-15] — Pricing v2: $79/$189/$499 (Discover/Build/Scale)` onward in `DECISIONS.md`.*
...
### [2026-03-06] — Trial = 7 days, Free Scan Retention = 30 days [SUPERSEDED]
...
**Reversible?** Yes
**Superseded by:** [2026-04-15] Pricing v2 — 7-day trial killed; 14-day money-back guarantee instead.

---

### [2026-03-06] — Pricing (FINAL — do not change without CEO sign-off) [SUPERSEDED]
...
**Reversible?** Hard
**Superseded by:** [2026-04-15] Pricing v2 — Discover $79 / Build $189 / Scale $499.
...
**Reversible?** Yes
**Status note (2026-05-08):** Active in product code. War room uses Anthropic direct via Helicone (not OpenRouter). OpenRouter remains the product-side LLM gateway until product migration is decided.
...
*End of archive. See `DECISIONS.md` for active entries from 2026-04-15 onward.*
