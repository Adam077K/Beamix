  ...
  const engineBehaviors: Record<string, {
    ...
    perplexity: [
      ...
      { mentioned: true,  pos: 2, score: 0.85, sentiment: 'positive',
        context: 'For AI search ranking queries, Beamix is cited with a direct reference to its FAQ Builder and Schema Generator agents. Perplexity cites beamixai.com and G2 reviews.' },
    ...
    for (let qi = 0; qi < querySubset.length; qi++) {
      ...
      for (const engine of engines) {
        ...
        rows.push({
          ...
          // sentiment_score CHECK is 0-100 (non-negative). Map behavior.score
          // in [-1..+1] → [0..100] linearly so negative sentiments don't violate the CHECK.
          sentiment_score: Math.round((behavior.score + 1) * 50),
...
async function seedAgentJobs(
  ...
  const jobEntries: JobEntry[] = [
    // Day 0-2: running/recent
    {
      ...
      credits_cost: 5,
      llm_calls: 0,
      input_params: { target_url: 'https://beamixai.com/features', optimize_for: ['chatgpt', 'perplexity'] },
    ...
    },
    {
      ...
      credits_cost: 3,
      llm_calls: 2,
      input_params: { page_url: 'https://beamixai.com/pricing', faq_count: 8 },
      trigger_source: 'automation',
    },
    // Day 1
    {
    ...
    // Day 2
    {
      ...
      llm_calls: 4,
      qa_score: 87,
      input_params: { page_url: 'https://beamixai.com/about', staleness_threshold_days: 180 },
    ...
    // Day 3
    {
      ...
      llm_calls: 2,
      qa_score: 95,
      input_params: { page_url: 'https://beamixai.com', schema_types: ['SoftwareApplication', 'Organization'] },
    ...
    // Day 4
    {
      ...
      llm_calls: 5,
      qa_score: 91,
      input_params: { page_url: 'https://beamixai.com/blog/what-is-geo', faq_count: 6 },
    ...
    // Day 5
    {
      ...
      credits_cost: 0,
      llm_calls: 1,
      input_params: { target_url: 'https://beamixai.com/changelog', optimize_for: ['gemini'] },
    ...
    // Day 7
    {
      ...
      llm_calls: 6,
      qa_score: 91,
      input_params: { target_url: 'https://beamixai.com', optimize_for: ['gemini', 'aio'] },
    ...
    // Day 8
    {
      ...
      llm_calls: 3,
      qa_score: 88,
      input_params: { page_url: 'https://beamixai.com/features', staleness_threshold_days: 90 },
    ...
    // Day 9
    {
      ...
      llm_calls: 2,
      qa_score: 97,
      input_params: { page_url: 'https://beamixai.com/pricing', schema_types: ['FAQPage', 'PriceSpecification'] },
    ...
    // Day 10
    {
      ...
      llm_calls: 7,
      qa_score: 85,
      input_params: { target_url: 'https://beamixai.com/blog/geo-vs-seo', optimize_for: ['chatgpt', 'claude'] },
    ...
    // Day 11
    {
      ...
      credits_cost: 0,
      llm_calls: 1,
      input_params: { page_url: 'https://beamixai.com/integrations', faq_count: 5 },
    ...
    // Day 13
    {
      ...
      llm_calls: 4,
      qa_score: 90,
      input_params: { page_url: 'https://beamixai.com/blog/ai-search-optimization', staleness_threshold_days: 60 },
    ...
    // Day 14
    {
      ...
      llm_calls: 2,
      qa_score: 94,
      input_params: { page_url: 'https://beamixai.com/about', schema_types: ['Organization', 'WebSite'] },
    ...
    // Day 15
    {
      ...
      llm_calls: 6,
      qa_score: 87,
      input_params: { target_url: 'https://beamixai.com/pricing', optimize_for: ['perplexity', 'aio'] },
    ...
    // Day 17
    {
      ...
      llm_calls: 4,
      qa_score: 88,
      input_params: { page_url: 'https://beamixai.com/blog/perplexity-optimization', faq_count: 5 },
    ...
    // Day 19
    {
      ...
      llm_calls: 3,
      qa_score: 82,
      input_params: { page_url: 'https://beamixai.com/blog/chatgpt-citations', staleness_threshold_days: 90 },
    ...
    // Day 20
    {
      ...
      credits_cost: 0,
      llm_calls: 0,
      input_params: { page_url: 'https://beamixai.com/demo', schema_types: ['Product'] },
    ...
    // Day 21
    {
      ...
      llm_calls: 5,
      qa_score: 83,
      input_params: { target_url: 'https://beamixai.com/blog/geo-for-smbs', optimize_for: ['chatgpt'] },
    ...
    // Day 22
    {
      ...
      llm_calls: 4,
      qa_score: 85,
      input_params: { page_url: 'https://beamixai.com', faq_count: 4 },
    ...
    // Day 24
    {
      ...
      llm_calls: 3,
      qa_score: 86,
      input_params: { page_url: 'https://beamixai.com/blog/google-ai-overviews', staleness_threshold_days: 45 },
    ...
    // Day 25
    {
      ...
      llm_calls: 2,
      qa_score: 93,
      input_params: { page_url: 'https://beamixai.com/blog', schema_types: ['Blog', 'BreadcrumbList'] },
    ...
    // Day 26
    {
      ...
      llm_calls: 6,
      qa_score: 81,
      input_params: { target_url: 'https://beamixai.com/blog/ahrefs-alternative', optimize_for: ['perplexity', 'youcom'] },
    ...
    // Day 27
    {
      ...
      llm_calls: 4,
      qa_score: 84,
      input_params: { page_url: 'https://beamixai.com/blog/what-is-geo', faq_count: 5 },
      output_data: { faqs_generated: 5, schema_added: true },
      trigger_source: 'automation',
    },
    // Day 28
    ...
    // Day 29
    {
      ...
      llm_calls: 3,
      qa_score: 79,
      input_params: { page_url: 'https://beamixai.com/blog/ai-citations-guide', staleness_threshold_days: 90 },
    ...
    // Day 30
    {
      ...
      llm_calls: 2,
      qa_score: 90,
      input_params: { page_url: 'https://beamixai.com/blog/first-post', schema_types: ['Article', 'BreadcrumbList'] },
  ...
  const jobs = jobEntries.map((entry) => {
    ...
    return {
      ...
      // qa_score is numeric(3,2) (max 9.99) — entries author as 78-97, divide by 100.
      qa_score: entry.qa_score != null ? entry.qa_score / 100 : null,
  ...
  "@graph": [
    {
      ...
      "@id": "https://beamixai.com/#software",
      "name": "Beamix",
    ...
    {
      "@type": "Organization",
      "@id": "https://beamixai.com/#organization",
      "name": "Beamix",
      "url": "https://beamixai.com",
...
Updated features page with current agent descriptions and proactive suggestion system.`,
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      word_count: 0,
      published_url: 'https://beamixai.com/pricing',
...
Updated copy targeting high-density GEO terminology for AI engine training signal.`,
      ...
      word_count: 260,
      published_url: 'https://beamixai.com/features',
...
SEO and GEO use fundamentally different signals. This post explains why and what to do about it.`,
      ...
      word_count: 410,
      published_url: 'https://beamixai.com/blog/geo-vs-seo',
...
async function seedNotifications(supabase: SupabaseClient, userId: string): Promise<void> {
  const notifications = [
    ...
    },
    {
      ...
      body: '"Features Page — GEO Terminology Refresh" was approved and published to beamixai.com/features.',
    ...
    },
    {
      ...
      body: 'Content Optimizer could not process beamixai.com/changelog — page returned a 404 during content fetch. No credits were charged.',
      type: 'agent_failed',
      severity: 'high',
      is_read: true,
...
export async function seedTesterDemoData(
  ...
  const { data: existing } = await supabase
    ...
    .select('id')
    .eq('user_id', userId)
    .eq('website_url', 'https://beamixai.com')
    .maybeSingle()
  ...
  if (existing?.id) {
    ...
    const { data: business, error: bizErr } = await supabase
      ...
      .insert({
        user_id: userId,
        name: 'Beamix.tech',
        website_url: 'https://beamixai.com',
