...
| D3 | **Free engine 4: Bing Copilot replacement** | `_SYSTEM_DESIGN_ARCHITECTURE_LAYER.md`, scan engine, landing | Copilot locked as free engine 4 in decisions but has no public API and is Phase 3 deferred. Options: (a) Claude as engine 4 + make Claude available for scanning at all tiers, (b) 3 free engines until Copilot ready, (c) swap Copilot for You.com. |
