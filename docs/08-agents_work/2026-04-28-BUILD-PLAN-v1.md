...
Scope: Customer-embeddable JS snippet (< 3KB gzipped) that captures form submissions on their site and attributes them to Beamix UTM sources. Snippet hosted at `notify.beamixai.com/attr.js`. Once shipped, /scan and /home copy can include "form submissions" in attribution headlines.
