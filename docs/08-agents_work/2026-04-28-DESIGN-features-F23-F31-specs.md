...
- **React-PDF Link:** `import { Link } from '@react-pdf/renderer'`. The URL must be the absolute product URL (`https://app.beamixai.com/inbox?...`), not a relative path — PDF hyperlinks require absolute URLs.
...
Content area (max-width 760px, centered):
  ...
  Footer: "Generated by Beamix · [date] · beamixai.com"
