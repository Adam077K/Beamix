...
VERIFICATION_SUITE = [
    # P0: Security (CRITICAL)
    {
        ...
        "checks": [
            ...
            ("Dependency Analysis", "vulnerability-scanner/scripts/dependency_analyzer.py", False),
        ]
    },
    ...
    # P1: Code Quality (CRITICAL)
    {
        ...
        "checks": [
            ("Lint Check", "lint-and-validate/scripts/lint_runner.py", True),
            ("Type Coverage", "lint-and-validate/scripts/type_coverage.py", False),
        ]
    },
    ...
    # P2: Data Layer
    {
        "category": "Data Layer",
        "checks": [
            ("Schema Validation", "database-design/scripts/schema_validator.py", False),
        ]
    },
    ...
    # P3: Testing
    {
        "category": "Testing",
        "checks": [
            ("Test Suite", "testing-patterns/scripts/test_runner.py", False),
        ]
    },
    ...
    # P4: UX & Accessibility
    {
        ...
        "checks": [
            ("UX Audit", "frontend-design/scripts/ux_audit.py", False),
            ("Accessibility Check", "frontend-design/scripts/accessibility_checker.py", False),
        ]
    },
    ...
    # P5: SEO & Content
    {
        ...
        "checks": [
            ("SEO Check", "seo-fundamentals/scripts/seo_checker.py", False),
            ("GEO Check", "geo-fundamentals/scripts/geo_checker.py", False),
        ]
    },
    ...
    # P6: Performance (requires URL)
    {
        ...
        "requires_url": True,
        "checks": [
            ("Lighthouse Audit", "performance-profiling/scripts/lighthouse_audit.py", True),
            ("Bundle Analysis", "performance-profiling/scripts/bundle_analyzer.py", False),
        ]
    },
    ...
    # P7: E2E Testing (requires URL)
    {
        ...
        "requires_url": True,
        "checks": [
            ("Playwright E2E", "webapp-testing/scripts/playwright_runner.py", False),
        ]
    },
    ...
    # P8: Mobile (if applicable)
    {
        "category": "Mobile",
        "checks": [
            ("Mobile Audit", "mobile-design/scripts/mobile_audit.py", False),
        ]
    },
    ...
    # P9: Internationalization
    {
        ...
        "checks": [
            ("i18n Check", "i18n-localization/scripts/i18n_checker.py", False),
        ]
    },
]
...
def resolve_skill_script(project_path: Path, relative_path: str) -> Path:
    """Prefer canonical .claude scripts, fallback to legacy .agent paths."""
    for base in SKILL_BASE_CANDIDATES:
        candidate = project_path / base / relative_path
        if candidate.exists():
            return candidate
    # Return canonical target for deterministic reporting even when missing.
    return project_path / SKILL_BASE_CANDIDATES[0] / relative_path
  ...
  python scripts/verify_all.py . --url https://staging.example.com --no-e2e
    ...
    for suite in VERIFICATION_SUITE:
        ...
        for name, script_path, required in suite["checks"]:
            script = resolve_skill_script(project_path, script_path)
