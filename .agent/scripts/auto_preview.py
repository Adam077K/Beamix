...
Usage:
    ...
    # Runtime data defaults to .claude/ when available, with .agent/ fallback
"""
...
def resolve_runtime_dir() -> Path:
    """Use canonical .claude runtime location first, fallback to legacy .agent."""
    claude_dir = Path(".claude")
    if claude_dir.exists():
        return claude_dir
    return Path(".agent")

AGENT_DIR = resolve_runtime_dir()
