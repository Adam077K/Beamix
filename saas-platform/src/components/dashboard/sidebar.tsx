...
export function Sidebar({ businessName, planTier, trialDaysLeft, className }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Trial banner */}
      {showTrialBanner && (
        <div className="mx-2 mb-3 rounded-lg bg-gradient-to-br from-blue-50 to-sky-50 border border-blue-100 p-3">
          <p className="text-[11px] font-medium text-blue-800 mb-1">{trialDaysLeft} days left in trial</p>
          <div className="h-1 w-full rounded-full bg-blue-100 mb-2">
            <div
