      ...
      {Array.from({ length: total }, (_, i) => (
        <motion.div
          ...
          className={`rounded-full transition-colors duration-300 ${
            i === active
              ? 'h-2.5 w-2.5 bg-[#3370FF]'
              : i < active
              ? 'h-2 w-2 bg-[#3370FF]/40'
              : 'h-2 w-2 bg-black/15'
          }`}
        />
      ))}
  ...
  if (stepIndex === null) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-white">
        <Loader2 className="h-6 w-6 animate-spin text-[#3370FF]" />
      </div>
    )
  }
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-white px-4 py-12 font-sans">
      ...
      <div className="mb-10">
        <span className="font-bold text-2xl text-black">
          Beam<span className="text-[#3370FF]">ix</span>
        </span>
      </div>
        ...
        <AnimatePresence mode="wait">
          ...
          {currentStep === 'url' && (
            ...
            >
              <div className="mb-8 text-center">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#3370FF]/10">
                  <Globe className="h-7 w-7 text-[#3370FF]" />
                </div>
              ...
              <form onSubmit={urlForm.handleSubmit(handleUrlSubmit)} className="space-y-4">
                <Input
                  ...
                  className="h-12 rounded-xl border-black/15 text-base placeholder:text-black/30 focus-visible:ring-[#3370FF]"
                ...
                <Button
                  type="submit"
                  className="h-12 w-full rounded-full bg-[#3370FF] text-white hover:bg-[#3370FF]/90 text-base font-medium"
                >
                  Continue
          ...
          {currentStep === 'email' && (
            ...
            >
              <div className="mb-8 text-center">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#3370FF]/10">
                  <Mail className="h-7 w-7 text-[#3370FF]" />
                </div>
                <h1 className="text-2xl font-medium text-black">
                  What&apos;s your email?
                </h1>
              ...
              {displayedUrl && (
                <div className="mb-6 flex justify-center">
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[#3370FF]/10 px-3 py-1 text-xs font-medium text-[#3370FF]">
          ...
          {currentStep === 'business_name' && (
            ...
            >
              <div className="mb-8 text-center">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#3370FF]/10">
                  <Building2 className="h-7 w-7 text-[#3370FF]" />
                </div>
                <h1 className="text-2xl font-medium text-black">
          ...
          {currentStep === 'location' && (
            ...
            >
              <div className="mb-8 text-center">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#3370FF]/10">
                  <MapPin className="h-7 w-7 text-[#3370FF]" />
                </div>
                <h1 className="text-2xl font-medium text-black">
              ...
              <form onSubmit={locationForm.handleSubmit(handleLocationSubmit)} className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    className="h-12 w-full rounded-full bg-[#3370FF] text-white hover:bg-[#3370FF]/90 text-base font-medium disabled:opacity-60"
                  >
                    {isSubmitting ? (
                      <>
